 ...
 */
 ...
 https://kriss.io/buiding-chat-app-with-react-native-and-socketio-cjzi03e3e005bdes19yy89z7d/
 */
import React, {Component} from 'react';
import {SafeAreaView, Platform, StyleSheet, Text, View, Button, ScrollView} from 'react-native';
...
export default class App extends Component{
  ...
  componentWillMount()
  {
    ...
    // add listener รอรับ msg ที่ส่งมาจาก nodejs
    nodejs.channel.addListener(
      'message',
      (msg) => {
        console.log('nodejs.channel.addListener > message');
    ...
    nodejs.channel.addListener(
      ...
      (msg) => {
        ...
        console.log('Receive log requests from node.');
    ...
    this.socket = io("http://127.0.0.1:8787", {query:"foo=bar"});
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <View style={{flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center'}}>
          <Button 
            title='Clear logs'
            onPress={this.handleClearLogClick}
          />
